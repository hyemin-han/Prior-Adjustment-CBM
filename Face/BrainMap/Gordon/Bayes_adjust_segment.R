...
for (i in Range_start:Range_end){
	...
	dir.create(sprintf('output_%d',start))
	BF_result <- sprintf("./output_%d/BF_%d.Rdata",start,i)
	D_result <- sprintf("./output_%d/D_%d.Rdata",start,i)
